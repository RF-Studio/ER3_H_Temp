...
#include <libpic30.h>       // pour utiliser la macro __C30_UART avec le printf
...
// A utiliser avece les variables unsigned char REMAP_SIGNAL_IN_xxx de la fonction Lib_Temp_REMAP_SIGNAL_IN_SUR_RPx
...
//A utiliser avece les variables unsigned char REMAP_SIGNAL_OUT_xxx de la fonction Lib_Temp_REMAP_SIGNAL_OUT_SUR_RPx
...
// A utiliser avec les fonctions : Lib_Temp_REMAP_SIGNAL_IN_SUR_RPx et Lib_Temp_REMAP_SIGNAL_OUT_SUR_RPx
...
unsigned char Lib_Temp_MRF89_Lecture_SPI_FIFO(unsigned char *Reception);     // Retourne le nombre d'octets lus
...
void Lib_Temp_MRF89_Change_Adresse_de_ce_MRF(unsigned char Adresse);
void Lib_Temp_MRF89_Change_Mode(unsigned char Mode);
char Lib_Temp_MRF89_Change_Canal(unsigned char Canal);
char Lib_Temp_MRF89_Change_Taille_FIFO(unsigned char enum_MRF89_TAILLE_FIFO);
...
void Lib_Temp_REMAP_SIGNAL_IN_SUR_RPx(unsigned char REMAP_SIGNAL_IN_xxx, unsigned char RP_xx_xx);
void Lib_Temp_REMAP_SIGNAL_OUT_SUR_RPx(unsigned char REMAP_SIGNAL_OUT_xxx, unsigned char RP_xx_xx);
...
void Lib_Temp_RTCC_Conversion_Seconde_en_Date_String(unsigned long Date_seconde, char *Date_string);
...
float Lib_Temp_UART_Change_Vitesse_de_Transmission(float Fcyc, float Vitesse_en_Baud);
